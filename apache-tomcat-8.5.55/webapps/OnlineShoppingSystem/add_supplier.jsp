...
<body>
	<div class="reg_layout">
		<div class="reg_left">
			<p class="reg_left_firstp">添加供应商</p>
			<p class="reg_left_secondp">ADD SUPPLIER</p>
		</div>

		<div class="reg_center" style="margin-left: 150px">
			<div class="reg_form">
				<form id="form" action="servlet/AddSupplierServlet" method="post">
					<table>
						
						
						
						<tr>
							<td class="td_left"><label for="name">供应商名：</label></td>
							<td class="td_right"><input type="text" name="name" id="name"
								placeholder="请输入真实姓名 2-100个汉字" />
								<span id="s_name"></span>
							</td>
						</tr>
						<tr>
