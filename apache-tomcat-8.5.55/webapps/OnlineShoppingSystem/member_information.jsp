...
<html>
  ...
  <div class="col-lg-2" style="height: 600px;background-color: #1c232f">
  	...
  	<div class="col-lg-10" style="height: 600px;background-color: white">	
	  	...
	  	<div style="float: left">
	   		<form action="${pageContext.request.contextPath}/servlet/GetUserByPageServlet" class="form-inline" method="post">
			  <div class="form-group">
			    <label for="exampleInputName2">姓名</label>
			    <input name="name" style="width: 150px;" type="text" class="form-control" id="exampleInputName2" value="${condition.name[0]}">
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input name="email" style="width: 150px;" type="text" class="form-control" id="exampleInputName2" value="${condition.email[0]}" >
			  </div>
	   	...
	   	<form id="form" action="${pageContext.request.contextPath}/servlet/DelSelectServlet" method="post">
	   		<table align="center" class="table table-hover user_table">
		  		...
		  		<c:forEach items="${pb.pageList}" var="user" varStatus="s">
		  			<tr>
			  			...
			  			<td>${user.gender}</td>
			  			<td>
			  				<a class="btn btn-info" href="${pageContext.request.contextPath}/servlet/FindUserServlet?id=${user.id}">修改</a>
	  ...
	  <ul class="pagination" >
	    ...
	    <c:if test="${pb.currentPage != 1}">
	      ...
	      <a href="${pageContext.request.contextPath}/servlet/GetUserByPageServlet?currentPage=${pb.currentPage-1}&pageRows=5&name=${condition.name[0]}&tel=${condition.tel[0]}&email=${condition.email[0]}" aria-label="Previous">
	    ...
	    <c:forEach begin="1" end="${pb.totalPage}" var="i">
	    	...
	    	<c:if test="${pb.currentPage==i}">
	    		<li class="active">
		    	<a href="${pageContext.request.contextPath}/servlet/GetUserByPageServlet?currentPage=${i}&pageRows=5&name=${condition.name[0]}&tel=${condition.tel[0]}&email=${condition.email[0]}">
		    		${i}
		    	</a>
	    		</li>
	    	</c:if>
	    ...
	    <c:if test="${pb.currentPage != pb.totalPage}">
		  ...
		  <a href="${pageContext.request.contextPath}/servlet/GetUserByPageServlet?currentPage=${pb.currentPage+1}&pageRows=5&name=${condition.name[0]}&tel=${condition.tel[0]}&email=${condition.email[0]}" aria-label="Next">
