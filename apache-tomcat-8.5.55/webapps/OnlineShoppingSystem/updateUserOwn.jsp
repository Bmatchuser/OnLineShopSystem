...
<body>
	...
	<div class="reg_layout">
		...
		<div class="reg_center center">
			
			<div class="reg_form">
				<div style="margin-bottom: 20px">
					<h2 style="padding-left: 50px">用户信息修改</h2>
				</div>
				<form id="form" action="servlet/UpdateUserOwnServlet" method="post">
					<table>
						<tr>
							<td>
						...
						<div style="margin-left: 100px"	><%=request.getSession().getAttribute("user_update_error2") == null ? "" : request.getSession().getAttribute("user_update_error2") %></div>
